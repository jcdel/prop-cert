...
export const grpcClientFactory = createGrpcClientFactory(protoPath);
/**
 * Creates grpc clients factory.
 *
 * @param protoPath - path to `.proto` file.
 */
export function createGrpcClientFactory(protoPath) {
    ...
    const packageApi = grpcjs.loadPackageDefinition(packageDefinition);
    /**
     * Creates grpc client instance.
     */
    return function createGrpcClient(props) {
        return new packageApi.immudb.schema.ImmuService(props.address, props.credentials, props.options);
    };
}
// schema re-exports
