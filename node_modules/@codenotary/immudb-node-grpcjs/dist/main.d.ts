...
export declare const grpcClientFactory: (props: {
    /**
...
}) => import("./immudb/schema/ImmuService.js").ImmuServiceClient;
/**
 * Creates grpc clients factory.
 *
 * @param protoPath - path to `.proto` file.
 */
export declare function createGrpcClientFactory(protoPath: string): (props: {
    /**
     * Host and optionally port, e.g. '127.0.0.1:3322'
     */
    address: string;
 ...
 */
export declare type ImmuGrpcClientOptions = {
    /**
