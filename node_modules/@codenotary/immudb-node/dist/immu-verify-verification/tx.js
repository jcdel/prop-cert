...
export function verifyTx(props) {
    switch (props.type) {
...
export function refTxInTx(props) {
    ...
    if (props.ref.id.isEven()) {
        if (hash.leaf(props.ref.prevTxHash)
    ...
    const { sourceRoot: refPrevTxesMht, targetRoot: txPrevTexsMht, } = prove.rootsFromConsistencyProof({
...
export function txIsRefTx(props) {
    ...
    if (entryAndRefPrevTxesMhtFromEntryAndRefPrevTx
