 ...
 * - value
 */
export function toKVEntry(everything) {
 ...
 *   - value
 */
export function toKVEntries(everything) {
    const kvs = [];
    let rest = everything;
...
//# sourceMappingURL=kvEntry.js.map