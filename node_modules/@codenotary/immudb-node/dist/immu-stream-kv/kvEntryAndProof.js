 ...
 * - val/key
 */
export function toKVEntryAndProof(props) {
    ...
    const entry = everything.subarray(8, 8 + entryLength);
    const verifableTxLength = everything.readUInt32BE(8 + entryLength + 4);
    const verifiableTx = everything.subarray(8 + entryLength + 8, 8 + entryLength + 8 + verifableTxLength);
    const inclusionProofLength = everything.readUInt32BE(8 + entryLength + 8 + verifableTxLength + 4);
    const inclusionProof = everything.subarray(8 + entryLength + 8 + verifableTxLength + 8, 8 + entryLength + 8 + verifableTxLength + 8 + inclusionProofLength);
    const valLength = everything.readUInt32BE(8 + entryLength + 8 + verifableTxLength + 8 + inclusionProofLength + 4);
    const val = everything.subarray(8 + entryLength + 8 + verifableTxLength + 8 + inclusionProofLength + 8, 8 + entryLength + 8 + verifableTxLength + 8 + inclusionProofLength + 8 + valLength);
    if (everything.byteLength
        !==
...
//# sourceMappingURL=kvEntryAndProof.js.map