 ...
 *
 */
export function hashOfZSetEntry(props) {
    ...
    const prefixedReferredKeyLength = buffer.fromUInt64BEAsNumber(prefixReferredKey.byteLength
    ...
    const zSetKeyLength = prefixZKey.byteLength
    ...
    const entryHash = hash.ofTreeBuffers(buffer.fromUInt16BE(metaLength), meta, buffer.fromUInt16BE(zSetKeyLength), zSetKey, hash.ofTreeBuffers(value));
    return entryHash;
}
