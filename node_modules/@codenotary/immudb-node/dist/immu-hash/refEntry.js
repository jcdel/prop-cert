 ...
 */
export function hashOfRefEntry(props) {
    ...
    const entryHash = hash.ofTreeBuffers(buffer.fromUInt16BE(metaLength), meta, prefixedKeyLength, [
        prefixKey,
        key,
    ], hash.ofTreeBuffers(prefixValueRef, value));
    return entryHash;
}
