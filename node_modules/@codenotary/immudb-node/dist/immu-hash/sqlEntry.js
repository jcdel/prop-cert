 ...
 */
export function hashOfSqlRowEntry(props) {
    ...
    const keyLength = prefixSql.byteLength
    ...
    const entryHash = hash.ofTreeBuffers(buffer.fromUInt16BE(metaLength), meta, buffer.fromUInt16BE(keyLength), key, hash.ofTreeBuffers(value));
    return entryHash;
}
/**
 ...
 */
export function hashOfSqlColumnEntry(props) {
    const meta = entryMetaToBuffer(props.meta);
    const metaLength = meta.byteLength;
    const prefixSql = consts.PrefixKeySql;
 ...
 */
export function hashOfSqlIndexEntry(props) {
    const meta = entryMetaToBuffer(props.meta);
    const metaLength = meta.byteLength;
    const prefixSql = consts.PrefixKeySql;
 ...
 */
export function hashOfSqlTableEntry(props) {
    const meta = entryMetaToBuffer(props.meta);
    const metaLength = meta.byteLength;
    const prefixSql = consts.PrefixKeySql;
 ...
 */
export function hashOfSqlDbEntry(props) {
    const meta = entryMetaToBuffer(props.meta);
    const metaLength = meta.byteLength;
    const prefixSql = consts.PrefixKeySql;
