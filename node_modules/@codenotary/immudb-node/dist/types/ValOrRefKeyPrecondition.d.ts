 ...
 */
export declare type ValOrRefKeyPrecondition = ValOrRefKeyPreconditionKeyExist | ValOrRefKeyPreconditionKeyNotExist | ValOrRefKeyPreconditionKeyNotModified;
/** Key must exist condition. */
export declare type ValOrRefKeyPreconditionKeyExist = {
    type: 'key-must-exist';
    key: Buffer;
};
/** Key must exist condition. */
export declare type ValOrRefKeyPreconditionKeyNotExist = {
    type: 'key-must-not-exist';
    key: Buffer;
};
/** Key must not be modified since transaction with id condition. */
export declare type ValOrRefKeyPreconditionKeyNotModified = {
    type: 'key-must-not-be-modified';
    key: Buffer;
    txId: Long;
};
//# sourceMappingURL=ValOrRefKeyPrecondition.d.ts.map