...
export declare type DBRuntimeInfo = {
    /**
 ...
 *
 */
export declare type DatabaseSettings = DatabaseSettingsReadonly & DatabaseSettingsUpdatable;
/**
 * Database changable settings
 */
export declare type DatabaseSettingsUpdatable = {
    /**
 ...
 */
export declare type DatabaseSettingsReadonly = {
    /**
 ...
 */
export declare type ReplicationSettings = {
    /**
 ...
 * Indexing settings
 */
export declare type IndexSettings = IndexSettingsUpdatable & IndexSettingsReadonly;
/**
 * Indexing unchangable settings
 */
export declare type IndexSettingsReadonly = {
    /**
     * max size of btree node in bytes
     */
    maxNodeSize?: number;
};
export declare type IndexSettingsUpdatable = {
    /**
