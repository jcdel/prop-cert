import { binEntryToSqlColumnEntry, isBinEntryKeySqlColumnEntryPart, sqlColumnEntryToBinEntry, sqlColumnEntryToLeafEntryPrefixedKey } from './SqlColumnEntry.js';
import { binEntryToSqlDbEntry, isBinEntryKeySqlDbEntryPart, sqlDbEntryToBinEntry, sqlDbEntryToLeafEntryPrefixedKey } from './SqlDbEntry.js';
import { binEntryToSqlIndexEntry, isBinEntryKeySqlIndexEntryPart, sqlIndexEntryToBinEntry, sqlIndexEntryToLeafEntryPrefixedKey } from './SqlIndexEntry.js';
import { binEntryToSqlRowEntry, isBinEntryKeySqlRowEntryPart, sqlRowEntryToLeafEntryPrefixedKey, sqlRowEntryToSqlBinEntry } from './SqlRowEntry.js';
import { binEntryToSqlTableEntry, isBinEntryKeySqlTableEntryPart, sqlTableEntryToBinEntry, sqlTableEntryToLeafEntryPrefixedKey } from './SqlTableEntry.js';
export function binEntryToSqlEntryType(props) {
...
export function binEntryToSqlEntry(props) {
...
export function sqlEntryToBinEntry(props) {
...
export function sqlEntryToLeafEntryPrefixedKey(props) {
    switch (props.sqlType) {
...
//# sourceMappingURL=SqlEntry.js.map