...
import { PrefixKeySql, TagSqlIndex, } from '../immu-hash/consts.js';
export function binEntryToSqlIndexEntry(props) {
...
export function sqlIndexEntryToBinEntry(props) {
 ...
 */
export function isBinEntryKeySqlIndexEntryPart(b) {
 ...
 *
 */
export function binEntryPrefixedKeyToSqlIndexEntryPart(b) {
    const sqlTag = TagSqlIndex;
    let index = 0;
...
export function sqlIndexEntryToLeafEntryPrefixedKey(entry) {
 ...
 *
 */
export function binEntryPrefixedValToSqlIndexEntryPart(b) {
    let index = 0;
...
export function sqlIndexEntryToBinEntryPrefixedVal(props) {
    return Buffer.concat([
        Buffer.of(props.indexIsPrimary),
        Buffer.concat(props.columns.map(indexColumn => Buffer.concat([
            buffer.fromUInt32BE(indexColumn.id),
            Buffer.of(indexColumn.ascDesc)
        ])))
    ]);
}
//# sourceMappingURL=SqlIndexEntry.js.map