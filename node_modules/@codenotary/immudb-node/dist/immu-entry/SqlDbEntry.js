...
import { PrefixKeySql, TagSqlDb, } from '../immu-hash/consts.js';
export function binEntryToSqlDbEntry(props) {
...
export function sqlDbEntryToBinEntry(props) {
 ...
 */
export function isBinEntryKeySqlDbEntryPart(b) {
 ...
 *
 */
export function binEntryPrefixedKeyToSqlDbEntryPart(b) {
    const sqlTag = TagSqlDb;
    let index = 0;
...
export function sqlDbEntryToLeafEntryPrefixedKey(entry) {
 ...
 *
 */
export function binEntryPrefixedValToSqlDbEntryName(b) {
    return b.toString('utf8');
}
export function sqlDbEntryToBinEntryPrefixedVal(props) {
    return Buffer.from(props.dbName);
}
//# sourceMappingURL=SqlDbEntry.js.map