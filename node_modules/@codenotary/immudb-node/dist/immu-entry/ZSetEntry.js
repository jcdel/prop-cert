...
import { PrefixKeyVal, PrefixKeyZSet } from '../immu-hash/consts.js';
export function binEntryToZSetEntry(props) {
...
export function zSetEntryToBinEntry(props) {
    return {
        type: 'bin',
        version: '1',
        meta: props.meta,
...
export function zSetEntryToLeafEntryPrefixedKey(entry) {
    ...
    const keyPrefixAndKeyLength = buffer.fromUInt16BE(1 + entry.referredKey.byteLength);
...
export function decodeBinEntryKeyAsZSetEntryPart(zKey, offset) {
    let index = offset ?? 0;
...
//# sourceMappingURL=ZSetEntry.js.map