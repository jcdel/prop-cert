...
import { isFlagAutoIncrementSet, isFlagNotNullSet, PrefixKeySql, setColumnFlags, TagSqlColumn, } from '../immu-hash/consts.js';
export function binEntryToSqlColumnEntry(props) {
...
export function sqlColumnEntryToBinEntry(props) {
    return {
        type: 'bin',
        version: '1',
        meta: props.meta,
...
export function sqlColumnEntryToLeafEntryPrefixedKey(props) {
...
export function sqlColumnEntryToLeafEntryPrefixedVal(props) {
    return Buffer.concat([
 ...
 */
export function isBinEntryKeySqlColumnEntryPart(b) {
 ...
 *
 */
export function binEntryPrefixedKeyToSqlColumnEntryPart(b) {
    const sqlTag = TagSqlColumn;
    let index = 0;
 ...
 */
export function binEntryPrefixedValToSqlColumnEntryPart(b) {
    let index = 0;
...
//# sourceMappingURL=SqlColumnEntry.js.map