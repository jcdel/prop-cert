...
export function binEntryToSqlRowEntry(props) {
...
export function sqlRowEntryToSqlBinEntry(props) {
    return {
        type: 'bin',
        version: '1',
        meta: props.meta,
 ...
 */
export function isBinEntryKeySqlRowEntryPart(b) {
    if (b[0] !== 0x02) {
        return false;
    }
 ...
 * - pk: Bytes
 */
export function decodeBinEntryKeyToSqlRowEntryPart(b) {
    const sqlTag = TagSqlRow;
    let index = 0;
...
export function sqlRowEntryToLeafEntryPrefixedKey(entry) {
 ...
 */
export function decodeValueSqlRow(b) {
    let index = 0;
 ...
 */
export function decodeSqlRowColumnValue(b) {
    let index = 0;
 ...
 *
 */
export function decodeSqlRowColumnsValues(b) {
    const result = [];
...
export function encodeValueSqlRow(props) {
    return Buffer.concat([
...
//# sourceMappingURL=SqlRowEntry.js.map