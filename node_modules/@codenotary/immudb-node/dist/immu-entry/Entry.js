import { binEntryToRefEntry, refEntryToBinEntry, refEntryToLeafEntryPrefixedKey } from './RefEntry.js';
import { binEntryToSqlEntry, sqlEntryToBinEntry, sqlEntryToLeafEntryPrefixedKey } from './SqlEntry.js';
import { binEntryToValEntry, valEntryToBinEntry, valEntryToLeafEntryPrefixedKey } from './ValEntry.js';
import { binEntryToZSetEntry, zSetEntryToBinEntry, zSetEntryToLeafEntryPrefixedKey } from './ZSetEntry.js';
export function binEntryToEntryType(props) {
...
export function binEntryToEntry(props) {
...
export function entryToBinEntry(props) {
    switch (props.type) {
        case 'bin': return props;
        case 'hash': return props;
...
export function entryToLeafEntryPrefixedKey(props) {
    switch (props.type) {
