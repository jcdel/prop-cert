...
import { PrefixKeySql, TagSqlTable, } from '../immu-hash/consts.js';
export function binEntryToSqlTableEntry(props) {
...
export function sqlTableEntryToBinEntry(props) {
 ...
 */
export function isBinEntryKeySqlTableEntryPart(b) {
 ...
 *
 */
export function binEntryPrefixedKeyToSqlTableEntryPart(b) {
    const sqlTag = TagSqlTable;
    let index = 0;
...
export function sqlTableEntryToLeafEntryPrefixedKey(entry) {
 ...
 *
 */
export function binEntryPrefixedValToSqlTableEntryName(b) {
    return b.toString('utf8');
}
export function sqlTableEntryToBinEntryPrefixedVal(props) {
    return Buffer.from(props.tableName);
}
//# sourceMappingURL=SqlTableEntry.js.map