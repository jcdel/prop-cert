 ...
 * ```
 */
export declare function fromObject(object: ExtendedJSONAble): Buffer;
/**
 ...
 * ```
 */
export declare function toObject<T extends ExtendedJSONAble>(buffer: Buffer): T;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromUInt16BE(number: number): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromUInt32BE(number: number): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromDoubleBe(number: number): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromUInt64BEAsBigInt(number: bigint): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromUInt64BEAsLong(number: Long): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function fromUInt64BEAsNumber(number: number): Buffer;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function toDoubleBe(buf: Buffer, offset?: number): number;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function toUInt64BE(buf: Buffer, offset?: number): Long;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function toUInt32BE(buf: Buffer, offset?: number): number;
/**
 * Same as:
 *
 * ```ts
 ...
 * ```
 */
export declare function toUInt16BE(buf: Buffer, offset?: number): number;
