...
export function promisifyGrpcWriter(callFunction) {
    return function grpcWriter(props) {
        return new Promise((resolve, reject) => {
            if (props.cancelSignal?.aborted === true) {
                reject(new common.OperationCanceledError('Operation cancelled by client before started.'));
            }
            const info = [];
...
//# sourceMappingURL=promisifyGrpcWriter.js.map