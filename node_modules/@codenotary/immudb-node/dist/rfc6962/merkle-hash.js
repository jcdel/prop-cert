 ...
 * @returns merkle hash
 */
export function merkelHashOf(things) {
    return merkleHashOfN(things);
}
function merkleHashOfN(things) {
...
function merkelHashOfOne(thing) {
 ...
 */
export function maxPowOf2LessOrEqTo(n) {
...
//# sourceMappingURL=merkle-hash.js.map