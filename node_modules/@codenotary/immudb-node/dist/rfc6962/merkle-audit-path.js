 ...
 */
export function merkleAuditPathNav(thingsLength, m) {
    if (m < 0) {
...
function merkleAuditPathNavInternal(thingsLength, m) {
 ...
 */
export function merkleAuditPath(things, m) {
    if (m < 0) {
        throw new RangeError('thing index can not be less than 0');
    }
    if (m >= things.length) {
...
function merkleAuditPathInternal(things, m) {
 ...
 */
function maxPowOf2LessOrEqTo(n) {
...
//# sourceMappingURL=merkle-audit-path.js.map