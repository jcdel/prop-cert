 ...
 * ```
 */
export function fromUInt16BE(number) {
 ...
 * ```
 */
export function fromUInt32BE(number) {
    const buf = Buffer.alloc(4);
    buf.writeUInt32BE(number);
    return buf;
}
 ...
 * ```
 */
export function fromDoubleBe(number) {
    const buf = Buffer.alloc(8);
    buf.writeDoubleBE(number);
    return buf;
}
 ...
 * ```
 */
export function fromUInt64BEAsBigInt(number) {
    const buf = Buffer.alloc(8);
    buf.writeBigUInt64BE(number);
    return buf;
}
 ...
 * ```
 */
export function fromUInt64BEAsLong(number) {
 ...
 * ```
 */
export function fromUInt64BEAsNumber(number) {
 ...
 * ```
 */
export function toDoubleBe(buf, offset) {
 ...
 * ```
 */
export function toUInt64BE(buf, offset) {
    offset = offset ?? 0;
 ...
 * ```
 */
export function toUInt32BE(buf, offset) {
 ...
 * ```
 */
export function toUInt16BE(buf, offset) {
