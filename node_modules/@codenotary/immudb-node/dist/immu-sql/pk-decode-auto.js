 ...
 * ```
 */
export function decodePK(props) {
    const namedPKs = [];
...
export function decodePKInt(b, offset) {
    let index = offset ?? 0;
...
export function decodePKBoolean(b, offset) {
    let index = offset ?? 0;
    const isNotNull = b[index] === 0 ? true : false;
    index += 1;
...
export function decodePKTimespan(b, offset) {
    let index = offset ?? 0;
    const isNotNull = b[index] === 0 ? true : false;
    index += 1;
    let shiftedUInt64BE = [...b.subarray(index, index + 8)];
 ...
 *
 */
export function decodePKString(b, offset) {
    let index = offset ?? 0;
    const isNotNull = b[index] === 0 ? true : false;
    index += 1;
 ...
 *
 */
export function decodePKBlob(b, offset) {
    let index = offset ?? 0;
    const isNotNull = b[index] === 0 ? true : false;
    index += 1;
...
//# sourceMappingURL=pk-decode-auto.js.map