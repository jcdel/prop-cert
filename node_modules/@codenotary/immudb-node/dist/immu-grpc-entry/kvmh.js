...
export function kvmhToEntry(props) {
...
export function kvmhToEntryType(props) {
...
function kvmhToHashEntry(props) {
    return {
        type: 'hash',
        version: '1',
        meta: props.meta,
...
function kvmhToZSetEntry(props) {
...
function kvmhToSqlEntryType(props) {
...
function kvmhToSqlRowEntry(props) {
...
function kvmhToSqlColumnEntry(props) {
...
function kvmhToSqlIndexEntry(props) {
...
function kvmhToSqlTableEntry(props) {
...
function kvmhToSqlDbEntry(props) {
